...
export default function Navbar() {
    return (
        <div className="flex flex-row place-content-center justify-center md:place-content-between text-center p-2 sm:p-4 w-screen bg-stone-300 bg-opacity-20">
            <motion.h1 initial={{ x: -50, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: .5 }} className="p-4 ml-2 text-2xl md:text-5xl text-center"><a className="hover:opacity-75" href="/"><AiOutlineHome /></a></motion.h1>
