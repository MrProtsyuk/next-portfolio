        ...
        <motion.div
            ...
            <div className="flex flex-col lg:flex-row justify-center m-2 p-2 lg:m-6 lg:p-6">
                ...
                <motion.p
                        ...
                        className="flex mt-4 md:mt-16 ml-4 md:ml-24 lg:ml-0 m-4 text-center text-sm sm:text-md xl:text-xl">Hey there!👋 My name is Mark Protsyuk and I have been a dev for about 2 years now. I started my journey back in 2020, when I took a web development class in community college. Since then, I have graduated from the UC Davis coding bootcamp 🎓 and have been teaching myself development skills, as well as being mentored by fellow peers. I started my journey as a web developer 🌐, specializing in NextJS and Apollo GraphQL but recently I began to learn C++ and Unreal Engine 5 because I have always dreamed of getting into game development 🎮. <br /> Check out some of the stuff I have worked on!</motion.p>
                    <motion.div
